...
set design_name base_system_ps_only
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {/home/phil/github/zybo/library/ZYBO_zynq_def.xml} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS { \
     ...
     1#unassigned#unassigned#Enet 0#Enet \
     Flash#Quad SPI \
     Flash#Quad SPI \
     Flash#Quad SPI \
     Flash#Quad SPI \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports IIC_0] [get_bd_intf_pins ps7/IIC_0]

  # Create port connections
  connect_bd_net -net gnd_dout [get_bd_pins gnd/dout] [get_bd_pins irq_concat/In0] [get_bd_pins irq_concat/In1] [get_bd_pins irq_concat/In2] [get_bd_pins ps7/SDIO0_WP]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps7/M_AXI_GP0_ACLK]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins irq_concat/dout] [get_bd_pins ps7/IRQ_F2P]
